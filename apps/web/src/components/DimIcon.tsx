  ...
  return (
    <svg height="18" width="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4">
      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5">
        <rect x="2.75" y="1.75" width="12.5" height="14.5" rx="2"></rect>
        <line x1="7.5" y1="4" x2="10.5" y2="4"></line>
      </g>
      <circle cx="9" cy="13.4" r="1" fill="currentColor"></circle>
    </svg>
  );
}
...
function ChromeIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 100 100" className="h-4 w-4">
      <linearGradient id="trell-chrome-b" x1="55.41" x2="12.11" y1="96.87" y2="21.87" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#1e8e3e"></stop>
        <stop offset="1" stopColor="#34a853"></stop>
      </linearGradient>
      <linearGradient id="trell-chrome-c" x1="42.7" x2="86" y1="100" y2="25.13" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#fcc934"></stop>
        <stop offset="1" stopColor="#fbbc04"></stop>
      </linearGradient>
      <linearGradient id="trell-chrome-a" x1="6.7" x2="93.29" y1="31.25" y2="31.25" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#d93025"></stop>
        <stop offset="1" stopColor="#ea4335"></stop>
      </linearGradient>
      <path fill="url(#trell-chrome-a)" d="M93.29 25a50 50 90 0 0-86.6 0l3 54z"></path>
      <path fill="url(#trell-chrome-b)" d="M28.35 62.5 6.7 25A50 50 90 0 0 50 100l49-50z"></path>
      <path fill="url(#trell-chrome-c)" d="M71.65 62.5 50 100a50 50 90 0 0 43.29-75H50z"></path>
      <path fill="#fff" d="M50 75a25 25 90 1 0 0-50 25 25 90 0 0 0 50z"></path>
      <path fill="#1a73e8" d="M50 69.8a19.8 19.8 90 1 0 0-39.6 19.8 19.8 90 0 0 0 39.6z"></path>
    </svg>
  );
}
...
function SafariIcon(): JSX.Element {
  return (
    <svg className="h-4 w-4" width="66" height="66" viewBox="0 0 66 66">
      <path
        fill="#C6C6C6"
        stroke="#C6C6C6"
        strokeLinecap="round"
      ...
      <path
        ...
        paint-order="markers stroke fill"
      ></path>
      <path d="m12.96732 50.59006 23.41607-15.75201 16.81513-22.66472z" opacity=".243"></path>
    </svg>
  );
}
...
function EdgeIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4">
      <defs>
        <linearGradient id="trell-edge-g" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#00BCF2"></stop>
          <stop offset="1" stopColor="#0C88C3"></stop>
        </linearGradient>
      </defs>
      <circle cx="12" cy="12" r="10" fill="url(#trell-edge-g)"></circle>
      <path
        d="M4.5 14.5c2.5.8 4.5-.3 5.8-2.3 1-1.6 2-3.4 3.9-4.2 2.3-1 4.9-.9 6.3.4-1.9-.4-3.9-.1-5.6.9-2.4 1.4-3.8 3.9-6 5.2-1.9 1.1-3.6 1-4.4 0z"
        fill="#fff"
      ></path>
    </svg>
  );
...
function FirefoxIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4">
      <circle cx="12" cy="12" r="10" fill="#FF7139"></circle>
      <circle cx="12" cy="12" r="6.2" fill="#fff"></circle>
      <circle cx="12" cy="12" r="4.6" fill="#0060DF"></circle>
      <path
        d="M12 2.5c2.8 1.6 4 4.3 3.8 7.2"
        fill="none"
        stroke="#FFBD4F"
        strokeWidth="1.8"
        strokeLinecap="round"
...
function OperaIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4">
      <ellipse cx="12" cy="12" rx="8" ry="9.5" fill="none" stroke="#FF1B2D" strokeWidth="3.6"></ellipse>
    </svg>
  );
}

function WindowsIcon(): JSX.Element {
  return <Image src="/icons/os-windows.svg" alt="Windows" width={16} height={16} className="h-4 w-4" />;
}

function AppleIcon(): JSX.Element {
  return <Image src="/icons/os-apple.svg" alt="Apple" width={16} height={16} className="h-4 w-4" />;
}
...
function AndroidIcon(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4">
      <g fill="#3DDC84">
        <path d="M7.5 9.5a4.5 4.5 0 0 1 9 0v1h-9v-1z"></path>
        <rect x="6" y="11" width="12" height="7.5" rx="2.5"></rect>
        <circle cx="9.7" cy="8" r=".9" fill="#fff"></circle>
        <circle cx="14.3" cy="8" r=".9" fill="#fff"></circle>
        <path d="M6.2 3.4 7.6 5.6M17.8 3.4l-1.4 2.2" stroke="#3DDC84" strokeWidth="1.4" strokeLinecap="round"></path>
      </g>
    </svg>
  );
}
...
function LinuxIcon(): JSX.Element {
  return <Image src="/icons/os-linux.svg" alt="Linux" width={16} height={16} className="h-4 w-4" />;
}
...
function GlobeIcon(): JSX.Element {
  return (
    ...
    >
      ...
      <path d="M12 3a13.5 13.5 0 0 1 0 18 13.5 13.5 0 0 1 0-18z"></path>
    </svg>
  );
}

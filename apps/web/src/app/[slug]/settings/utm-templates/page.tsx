                  ...
                  {editing === t.id ? (
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          onClick={saveEdit}
                          className="trell-btn-outline h-7 gap-1.5 text-xs disabled:opacity-40"
                        >
                          {saving ? "Saving…" : "Save"}
                        </button>
                        <button
                          onClick={() => setEditing(null)}
                          className="h-7 rounded-md px-2 text-xs text-trell-ink-muted hover:text-trell-ink transition-colors"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        {activeParams(t) > 0 && (
                          <button
                            onClick={() => void copyQueryString(t)}

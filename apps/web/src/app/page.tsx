...
export default async function Home() {
  ...
  // First-time users without a project route to onboarding to configure their first project.
  if (projects.length === 0) {
    redirect("/onboarding");
  }

  // Existing users with incomplete onboarding resume where they left off.

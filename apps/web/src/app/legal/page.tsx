...
export default function LegalPage() {
  return (
    <div className="py-8">
      ...
      <p className="mb-10 text-neutral-500">Policies, terms, and legal information for Trell.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <p className="text-sm text-neutral-500">The rules and guidelines for using Trell.</p>
        ...
        >
          ...
          <p className="text-sm text-neutral-500">How we collect, use, and protect your data.</p>
          <span className="mt-4 inline-block text-sm font-medium text-blue-600 group-hover:text-blue-700">
            Read more &rarr;
          </span>
        </Link>

 ...
 */
export function getSessionSegment(events: StoredEvent[], segment: Record<string, string> | undefined): Set<string> {
 ...
 */
export function buildSessionSegmentWhere(segment: Record<string, string> | undefined): {
  where: string;
  params: unknown[];
} {
  if (!segment || Object.keys(segment).length === 0) {
 ...
 */
export function filterEvents(events: StoredEvent[], filters: Record<string, string> | undefined): StoredEvent[] {
